...
describe('Coinbase address', function() {
    ...
    it('should extract lastest coinbase address', function() {
        const e1 = Entry.builder()
            ...
            .extId(
                '74fe4060bad3427598546838dcc41e4939f4fa9c85f633aab9c8d8a68d56a1086be7d4b38cfd99ec430610f56b62b630aba307ad5f584b532ddc07dd2db92a09'
            )
        ...
        const e2 = Entry.builder()
            ...
            .extId('014e5e8de90c21c09df91e8b05129404d55f0f555a2fe31800d53d6b42cf643f8c')
            .extId(
                'ec610761cb956106307d0bd1789a1a3ead4e2ad02824b2be276b9977b833bf09f644ad09b70698446183b706e03e8773bc2d0a4b04e778c3244c4503f6ec8703'
            )
        ...
        assert.equal(
            result.registrationEntryHash,
            'e3d14a96e24efeb5256054216940ee457042ac0dc958c1cc1b3c6d4f93fbd525'
        );
    ...
    it('should extract lastest coinbase address', function() {
        ...
        assert.equal(
            result[0].registrationEntryHash,
            'e3d14a96e24efeb5256054216940ee457042ac0dc958c1cc1b3c6d4f93fbd525'
        );
        ...
        assert.equal(
            result[1].registrationEntryHash,
            '0ade4b31030925f95c3c9ef1d3a8ba717b303e846393974d9c7ee9a645119cc6'
        );
